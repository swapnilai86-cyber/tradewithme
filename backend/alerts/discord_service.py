    ...
    async def handle_early_radar(self, data: dict) -> None:
        ...
        payload = {
            "embeds": [{
                ...
                "color": COLOR_YELLOW,
                "fields": [
                    {"name": "💰 Price",         "value": f"₹{data.get('price', 0):.2f}",          "inline": True},
                    {"name": "📊 RSI-14",         "value": f"{data.get('rsi', 0):.1f}",             "inline": True},
                    {"name": "📦 Vol Ratio",      "value": f"{data.get('vol_ratio', 0):.2f}x",       "inline": True},
                    {"name": "📐 Compression",   "value": f"{data.get('compression_pct', 0):.2f}%", "inline": True},
                    {"name": "📏 Dist to High",  "value": f"{data.get('dist_to_high_pct', 0):.2f}%","inline": True},
                    {"name": "📈 MACD Hist",     "value": f"{data.get('macd_hist', 0):.4f}",        "inline": True},
                ],
        ...
        payload = {
            "embeds": [{
                ...
                "fields": [
                    ...
                    {"name": "📊 RSI-14",         "value": f"{data.get('rsi', 0):.1f}",             "inline": True},
                    {"name": "📦 Vol Ratio",      "value": f"{data.get('vol_ratio', 0):.2f}x",       "inline": True},
                    {"name": "📏 Breakout Dist",  "value": f"{data.get('dist_from_breakout_pct', 0):.2f}%", "inline": True},
                    {"name": "🔑 Breakout Level", "value": f"₹{data.get('breakout_level', 0):.2f}", "inline": False},
                ],
                "footer": self._footer(data),
            }]
        }
        ...
        payload = {
            "embeds": [{
                ...
                "fields": [
                    ...
                    {"name": "📊 RSI-14",        "value": f"{data.get('rsi', 0):.1f}",          "inline": True},
                    {"name": "📦 Vol Ratio",     "value": f"{data.get('vol_ratio', 0):.2f}x",    "inline": True},
                    {"name": "🔑 Breakout Level","value": f"₹{data.get('breakout_level', 0):.2f}","inline": True},
                ],
                "footer": self._footer(data),
            }]
        }
        ...
        payload = {
            "embeds": [{
                ...
                "fields": [
                    ...
                    {"name": "🎯 Target",        "value": f"₹{data.get('target', 0):.2f}",        "inline": True},
                    {"name": "⚖️ Risk",          "value": f"₹{data.get('risk_amount', 0):,.0f}",  "inline": True},
                    {"name": "🏆 Reward",        "value": f"₹{data.get('reward_amount', 0):,.0f}","inline": True},
                    {"name": "📊 R:R",           "value": f"1:{data.get('rr_ratio', 0):.2f}",     "inline": True},
                ],
                "footer": self._footer(data),
            }]
        }
        ...
        payload = {
            "embeds": [{
                ...
                "fields": [
                    ...
                    {"name": "⏱ Hold",         "value": f"{data.get('hold_duration_mins', 0):.0f} min","inline": True},
                ],
                "footer": self._footer(data),
            }]
        }
